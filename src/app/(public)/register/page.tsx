...
const Register = () => {
  ...
  return (
    ...
    >
      ...
      <div className="text-[#09090B] font-semibold text-2xl pt-6 ">
        Create an account
      </div>
      <div className="text-[#71717A] text-sm font-normal pt-1 ">
        Enter your email, name and password below to create your account
      </div>
      <div className="pt-6">
        <div className="flex flex-col gap-1">
          ...
          />
          <div className="text-[#09090B] font-medium text-sm pb-1">
            Password
          </div>
          <Input
            data-cy="register-email-input"
        ...
        <button
          data-cy="register-continue-button"
          className="w-[350px] h-9 bg-black  hover:bg-slate-700 rounded-full text-[#FAFAFA] text-sm font-medium mt-4"
          onClick={() => register()}
          disabled={loading}
        >
          {loading ? (
        ...
        <Link href="/signIn">
          <button
            data-cy="signIn"
            className="w-[350px] h-9 bg-white  border-[#E4E4E7] rounded-full text-[#18181B] hover:bg-white border-2 text-sm font-medium mt-4"
          >
            Log in
          </button>
        </Link>
